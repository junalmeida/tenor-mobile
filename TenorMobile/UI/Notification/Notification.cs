...
namespace Tenor.Mobile.UI
{
    ...
    //    {
    //        ShowMessage(text, caption, critical, icon, NotificationType.HideDismiss, null);
    //    }
    //    /// <summary>
    //    /// Shows a notification to the user.
    //    /// </summary>
    ...
    //    /// <param name="critical"></param>
    //    /// <param name="icon"></param>
    //    public static void ShowMessage(string text, string caption, bool critical, Icon icon, NotificationType type, EventHandler callback)
    //    {
    ...
    //        switch (type)
    //        {
    //            case NotificationType.HideDismiss:
    //                notification.LeftSoftKey = new NotificationSoftKey(SoftKeyType.Hide, "Hide");
    //                break;
    //            case NotificationType.ViewDismiss:
    //                notification.LeftSoftKey = new NotificationSoftKey(SoftKeyType.Dismiss, "View");
    //                notification.LeftSoftKeyClick += new EventHandler(notification_LeftSoftKeyClick);
    //                break;
    //            default:
    //                break;
    //        }
    //        notification.RightSoftKey = new NotificationSoftKey(SoftKeyType.Dismiss, "Dismiss");
