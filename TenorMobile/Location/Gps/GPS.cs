...
{
    internal delegate void LocationChangedEventHandler(object sender, LocationChangedEventArgs args);
    internal delegate void DeviceStateChangedEventHandler(object sender, DeviceStateChangedEventArgs args);
    ...
    internal class Gps
    {
        ...
        /// </summary>
        internal event LocationChangedEventHandler LocationChanged
        {
            add
            {
        ...
        /// </summary>
        internal event DeviceStateChangedEventHandler DeviceStateChanged
        {
            add
            {
        ...
        internal GpsPosition GetPosition()
        {
        ...
        /// <returns>GpsPosition class with all the position details</returns>
        internal GpsPosition GetPosition(TimeSpan maxAge)
        {
        ...
        internal GpsDeviceState GetDeviceState()
        {
